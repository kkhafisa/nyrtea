...
@section('main-content')
    ...
    <div class="card shadow mb-4">
        ...
        <a href="{{ route('slide.create') }}" class="btn btn-primary btn-round"><i class="fa fa-plus"></i> Tambah Data</a>
        </div>
        <div class="card-body">
                            ...
                            <tr>
                                ...
                                <td>
                                    <form action="{{ route('slide.destroy',$data->id) }}"  method="POST">
                                        <a href="{{ route('slide.edit',$data->id) }}" class="btn btn-warning "><i class="fa fa-edit"></i> Ubah</a> 
                                        @csrf
                                        @method('DELETE')
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group focused">
                                    <label class="form-control-label" for="name">Nama Slide<span class="small text-danger">*</span></label>
                                    <input type="text" id="name" class="form-control" name="name" placeholder="Nama" >
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group focused">
                                <label class="form-control-label" for="name">Tanggal Slide</label>
