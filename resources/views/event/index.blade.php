...
@section('main-content')
    ...
    <div class="card shadow mb-4">
        ...
        <a href="{{ route('event.create') }}" class="btn btn-primary btn-round"><i class="fa fa-plus"></i> Tambah Data</a>
        </div>
        <div class="card-body">
                    ...
                    <tbody>
                        ...
                        @foreach($datas as $data)
                            ...
                            <tr>
                                <td scope="row">{{ $no }}</td>
                                <td>{{ $data->name }}</td>
                                <td>{{ $data->date_agenda }}</td>
                                <td>{{ $data->location }}</td>
                                <td>
                                    <form action="{{ route('event.destroy',$data->id) }}"  method="POST">
                                        <a href="{{ route('event.edit',$data->id) }}" class="btn btn-warning "><i class="fa fa-edit"></i> Ubah</a> 
                                        @csrf
                                        @method('DELETE')
